...
إيشو #11 للمراجعة النهائية تشمل التحليل والدليل بعد اكتمالهما. أي خلل يظهر أثناء التوثيق يحتاج إيشو إصلاح مستقلة. لا تُسجّل المهمة مكتملة في لوحة المشروع قبل المراجعة والدمج وفق قواعد الفريق؛ إن استُخدمت حالات Todo / In Progress / Done، اختر الحالة التي تعكس العمل الفعلي.
